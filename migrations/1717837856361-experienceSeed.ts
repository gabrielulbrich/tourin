...
export class ExperienceSeed1717837856361 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      INSERT INTO experiences.languages (iso_code,\`language\`) VALUES ('en','English'), ('ptBr','Portuguese'); 
      ...
      INSERT INTO experiences.options_languages_languages (options_id,languages_id) VALUES (1,1), (1,2); 
